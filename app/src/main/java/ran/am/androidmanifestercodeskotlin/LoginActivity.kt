...
class LoginActivity : AppCompatActivity() {
    ...
    lateinit  var mEmailSignInButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mEmailSignInButton.setOnClickListener(View.OnClickListener {
            ...
            val h = dbHelper!!.savedat(s1, s2)
            Toast.makeText(this@LoginActivity, "save success $h", Toast.LENGTH_SHORT).show()
        })
    }

    fun retrv(view: View?) {
        s3 = ed3!!.text.toString()
        val s = dbHelper!!.getloc(s3!!)
        t1!!.text = s
    }

    fun updatedata(view: View?) {
        s5 = ed4!!.text.toString()
        s4 = ed5!!.text.toString()
        val r = dbHelper!!.updateval(s4!!, s5)
        if (r == 1) {
